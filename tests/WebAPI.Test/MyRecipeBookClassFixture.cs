...
namespace WebAPI.Test
{
    public class MyRecipeBookClassFixture : IClassFixture<CustomWebApplicationFactory>
    {
        ...
        protected async Task<HttpResponseMessage> DoGet(string method, string token = "", string cultre = "en")
        {
            ChangeRequestCulture(cultre);
            AuthorizeRequest(token);
        ...
        protected void AuthorizeRequest(string token)
        {
