...
{
    public class GenerateRecipeInvalidTokeTest : MyRecipeBookClassFixture
    {
        private const string METHOD = "recipe/generate";

        public GenerateRecipeInvalidTokeTest(CustomWebApplicationFactory webApplication) : base(webApplication) { }
